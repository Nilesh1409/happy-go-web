...
export default function Popup() {
  ...
  const [data, setData] = useState({
    ...
    message:
      "We are a team of bike enthusiasts who are passionate about providing the best bike rental experience to our customers.",
    imageUrl:
      "https://lokeshshah.wordpress.com/wp-content/uploads/2015/12/bikeridejawadihills_001.jpg?w=1024&h=573",
    ctaLink: "/search",
