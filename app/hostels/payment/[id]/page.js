  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      if (hasExistingRazorpayOrder) {
        ...
        const orderResponse = await apiService.createBookingPayment(bookingId, apiPaymentType, useWallet);
      ...
      console.log("Initializing Razorpay with options: in hostel payment",process.env.NEXT_PUBLIC_RAZORPAY_KEY_ID)
