...
function BookingVerifyContent() {
  ...
  const handleInitiateDigiLocker = async (e) => {
    ...
    try {
      ...
      toast.error(
        "Error",
        error.message || "Failed to initialize verification.",
      );
    } finally {
      setLoading(false);
    }
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-lg shadow-lg">
        <CardHeader className="space-y-4 pb-4">
          ...
          <CardDescription>
            {step === 1 &&
              "Step 1/2: Verify your Aadhaar details via DigiLocker."}
            {step === 3 &&
              "Step 2/2: Upload Driving License for final verification."}
          </CardDescription>
        ...
        <CardContent>
          {step === 1 && (
            <form
              onSubmit={handleInitiateDigiLocker}
            ...
            >
              <div className="bg-blue-50 p-4 rounded-lg flex flex-col items-center justify-center space-y-2 border border-blue-100 mb-4">
                <p className="text-sm text-gray-700">
                  We use <span className="font-semibold">DigiLocker</span> to
                  securely verify your Aadhaar details. You will be redirected
                  to the DigiLocker website.
                </p>
              </div>
          ...
          {step === 2 && (
            <form onSubmit={handleVerifyOTP} className="space-y-4">
              <div className="bg-orange-50 p-4 rounded-lg flex flex-col items-center justify-center text-center space-y-2 border border-orange-100 mb-4">
                <p className="text-sm text-gray-600">
                  OTP sent to Aadhaar linked number for{" "}
          ...
          {step === 3 && (
            <form onSubmit={handleSubmitDL} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="dlNumber" className="text-sm font-medium">
              ...
              <div className="space-y-2">
                <Label htmlFor="dlFile" className="text-sm font-medium">
